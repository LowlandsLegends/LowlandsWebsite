...
export function CategorySelectorMobileComponent({ categories, selectedCategory, onSelect, onReset }: CategorySelectorMobileProps) {
    return (
        <div className="w-64 text-card-foreground p-4 rounded-lg md:hidden">
            <button
